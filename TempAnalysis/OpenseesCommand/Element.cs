...
namespace TempAnalysis.OpenseesCommand
{
    ...
    public class ZeroLengthElement : Element
    {
        ...
        public void WriteCommand(StreamWriter writer, List<int> Dirs, OpenSeesMaterial Material)
        {
            string mats = "";
            string dirs = "";
            ...
            writer.WriteLine($"element zeroLength {_ID} {Start.ID} {End.ID} -mat {mats} -dir {dirs} -doRayleigh;");
        }
    ...
    public class ShellElement: Element
    {
        ...
        public ShellElement(IDsManager IDM, List<BaseNode> Nodes, long SectionID) :base(IDM)
        {
            this.Nodes = Nodes;
