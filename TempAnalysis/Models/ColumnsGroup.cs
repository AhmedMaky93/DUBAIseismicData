...
namespace TempAnalysis.Models
{
    ...
    public class ColumnsGroup
    {
        ...
        public void CreateColumns(IDsManager IDM, GridSystem grid, Concrete02Material concrete01Material, SteelUniAxialMaterial steelMaterial, List<Location> locations, string key, int startFloor, int EndFloor)
        {
            ...
            for (int i = startFloor; i <= EndFloor; i++)
            {
                ...
                {
                    BaseNode Start = location.ToNode(grid, NodeType.BaseNode, IDM, i - 1);
                    BaseNode End = location.ToNode(grid, NodeType.BaseNode, IDM, i);
