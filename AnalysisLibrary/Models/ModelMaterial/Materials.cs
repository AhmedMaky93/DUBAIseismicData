...
namespace TempAnalysis.Models.ModelMaterial
{
    ...
    public class ModelMaterialsInfo
    {
        ...
        [DataMember]
        public PlateFromPlaneStressMaterial ConcreteShellsMaterial;
        ...
        internal void CreateMaterialsCommands(IDsManager IDM)
        {
            ...
            ConcreteShellsMaterial = new PlateFromPlaneStressMaterial(IDM,
                new PlaneStressUserMaterial(IDM, DefaultConcreteMaterial));
        }
        ...
        internal void WriteMaterialsCommands(StreamWriter file)
        {
            ...
            ConcreteShellsMaterial?.WriteCommand(file);
        }
