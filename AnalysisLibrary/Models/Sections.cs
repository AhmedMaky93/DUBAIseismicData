...
namespace TempAnalysis.Models
{
    ...
    public abstract class IFiberSection
    {
        public abstract RCSection GetFibers(Concrete02Material ConcMat, SteelUniAxialMaterial SteelMat, bool Vertical);
        public abstract double GetGJ(Concrete02Material ConcMat, SteelUniAxialMaterial SteelMat, bool Vertical);
    ...
    public class SteelBarInfo
    {
        ...
        public SteelBarInfo(SteelBarInfo other)
        {
            this.ID = other.ID;
    ...
    public class ShellReinforcement
    {
        ...
        public ShellReinforcement(ShellReinforcement other)
        {
            this.NumberOfBarsPerMeter = other.NumberOfBarsPerMeter;
            this.SteelBars = new SteelBarInfo(other.SteelBars);
        }
    ...
    public class SpecialBoundaryReinforcement
    {
        ...
        public SpecialBoundaryReinforcement(SpecialBoundaryReinforcement other)
        {
            LBE = other.LBE;
            Vertical_SBE_Length = other.Vertical_SBE_Length;
            VerticalBars = new SteelBarInfo(other.VerticalBars);
            StirrupsBars = new ShellReinforcement(other.StirrupsBars);
            No_AlongBars = other.No_AlongBars;
            No_VerticalBars = other.No_VerticalBars;
            No_VerticalTies = other.No_VerticalTies;
            No_AlongTies = other.No_AlongTies;
        }
    ...
    public class SpecialShearWallReinforcement : IFiberSection, IRectSection
    {
        ...
        public SpecialShearWallReinforcement(SpecialShearWallReinforcement other)
        {
            this.Length = other.Length;
            this.Thickness = other.Thickness;
            this.R_VW = new ShellReinforcement(other.R_VW);
            this.RHW = new ShellReinforcement(other.RHW);
            if(other.SpecialBoundary != null)
                this.SpecialBoundary = new SpecialBoundaryReinforcement(other.SpecialBoundary);
        }
        public bool EnLarge(ReinforcementUtility Utility, double FloorHeight, double MaxWallLength, double Increment)
        {
            if (Math.Abs(MaxWallLength - Length) > 1e-9)
            {
                Length += Increment;
                Thickness = Utility.GetAvailableThicknessFromWallLength(MaxWallLength, FloorHeight).First();
                return true;
            }

            foreach (double thickness in Utility.GetAvailableThicknessFromWallLength(Length, FloorHeight))
            {
                if (Math.Abs(Thickness - thickness) > 1e-9)
                {
                    Thickness = thickness;
                    return true;
                }
        ...
        public ElasticSectionProperties GenerateElasticPropertiesForEmbbeddedElement(Concrete02Material concrete01Material, SteelUniAxialMaterial steelMaterial)
        {
            double Reinf = GetRo();
            double thick = Thickness;
            double A = Math.Pow(thick, 2);
            double I = Math.Pow(thick, 4) / 12;
        ...
        internal double GetEqualThickness(bool Vertical)
        {
            return Vertical ? R_VW.GetEqualThickness() : RHW.GetEqualThickness();
        }
    }
    ...
    public abstract class FrameElementSection : IFiberSection
    {
        ...
        public FrameElementSection(FrameElementSection other)
        {
            this.SectionDepth = other.SectionDepth;
            this.StirrupsPerMeter = other.StirrupsPerMeter;
            this.StirupsSteelBars = other.StirupsSteelBars;
            this.Strirrips_D = new List<double>(other.Strirrips_D);
        }
    ...
    public class SquareColumnSection : FrameElementSection, IRectSection
    {
        ...
        public SquareColumnSection(SquareColumnSection other) : base(other)
        {
            MainSteelBars = new SteelBarInfo(other.MainSteelBars);
            NumberofBars = other.NumberofBars;
            RequireAdditionalStiffners = other.RequireAdditionalStiffners;
        }
    ...
    public class BeamSection : FrameElementSection, IRectSection
    {
        ...
        public BeamSection(BeamSection other):base(other)
        {
            SectionWidth = other.SectionWidth;
            MainSteelBars = new SteelBarInfo(other.MainSteelBars);
            NumberOfMainBars = other.NumberOfMainBars;
            SideSteelBars = new SteelBarInfo(other.SideSteelBars);
            SideBarsRows = other.SideBarsRows;
        }
        ...
        public ElasticSectionProperties GenerateElasticProperties(double Modifier,Concrete02Material concrete01Material, SteelUniAxialMaterial steelMaterial)
        {
            double Reinf = GetReinfRatio();
            return new ElasticSectionProperties
            {
        ...
        public Point2D GetMy(Concrete02Material concrete01Material, SteelUniAxialMaterial steelMaterial)
        {
            ...
            return new Point2D(M2, concUltimateStrain / C);
        }
